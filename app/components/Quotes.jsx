...
export default function Quotes() {
  return (
    <div className="main lg:h-[900px] h-[1200px] font-poppins flex flex-col justify-center items-center">
      <div className="great font-semibold text-2xl mb-3 text-purple-400">greatest minds of all times</div>
      <div className="free text-6xl font-bold">Become Free, Become Better</div>
      <div className="w-11/12 mt-8 grid grid-cols-3">



        <div className="container bg-[#6d6565] mt-2 md:w-[250px] md:h-[250px] lg:w-[310px] lg:h-[310px] xl:h-96 xl:w-96 rounded-2xl p-6 flex justify-center items-center">
        ...
        <div className="container bg-[#6d6565] mt-2 md:w-[250px] md:h-[250px] lg:w-[310px] lg:h-[310px] xl:h-96 xl:w-96 rounded-2xl p-6">
        <Image className=' rounded-2xl object-cover w-full h-full'
          src="/pm.jpg"
          width={250}
          height={250}
