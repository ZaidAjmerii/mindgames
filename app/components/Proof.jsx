...
export default function Proof() {
  return (
    ...
    <div className="text w-[450px] md:w-[500px] lg:w-2/3 flex flex-col gap-6">
      <div className="aboutus font-semibold text-purple-400">
        The Fake World
      </div>
      <div className="lf text-4xl lg:text-6xl font-poppins font-bold">The 1% Lifestyle is inside yourself.</div>
      <div className="description font-poppins font-semibold text-gray-300">The happiness of those who want to be popular depends on others; the happiness of those who seek pleasure fluctuates with moods outside their control; but the happiness of the wise grows out of their own free acts - Marcus Aurelius</div>
    ...
    <div className="img w-[480px] h-[700px] lg:w-[320px] lg:h-[466px] xl:w-[480px] xl:h-[700px]">
      <Image className=''
      src="/about-us.webp"
      width={480}
      height={700}
