...
function Hero() {
  return (
    <div className="main flex flex-col  h-[780px] max-md:gap-5 font-poppins mx-14 ">
      <div className="title font-bold text-7xl md:text-8xl lg:text-9xl mt-48">
          <div className='block'>
      ...
      <div className="cta w-[400px] md:w-[500px] mt-8 ml-2">
        <div className="font-semibold font-poppins text-slate-300 mb-4">Investing on your self and getting exposed to the information that being hidden to average humans is the way to win, and Win BIG!</div>
