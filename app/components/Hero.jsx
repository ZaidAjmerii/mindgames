...
function Hero() {
  return (
    <div className="main flex flex-col h-[780px] max-md:items-center max-md:gap-5 font-poppins mx-14 sm:my-0 my-32 ">
      <div className="title font-bold text-5xl max-md:flex items-center flex-col sm:text-7xl  text-nowrap md:text-8xl lg:text-9xl mt-48">
          <div className='block'>
